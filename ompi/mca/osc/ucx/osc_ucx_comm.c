 ...
 * The result is returned as void * because ompi_op_reduce() takes a
 * non-const source argument; the helper therefore absorbs the cast the
 * call sites previously applied to origin_addr directly.
 */
